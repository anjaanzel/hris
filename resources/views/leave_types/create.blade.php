    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Dodavanje tipa odsustva</h4>
                <div class="card-content">
                    <div class="row">
                        ...
                        <form action="{{route('leave_types.store')}}" method="POST">
                            ...
                            <div class="input-field no-margin">
                                <i class="material-icons prefix">account_balance</i>
                                <input type="text" name="procenat_satnice" id="procenat_satnice" class="validate" value="{{ Request::old('procenat_satnice') ? : '' }}">
                                <label for="opis">Procenat satnice</label>
