    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">Kreiranje novog zaposlenog</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl4 offset-xl2">
                                ...
                                <input type="text" name="pol" id="pol" value="{{Request::old('pol') ? : ''}}">
                            ...
                            <i class="material-icons prefix">business</i>
                                <select name="department">
                                    <option value="" disabled {{ old('department') ? '' : 'selected' }}>Odaberite departman</option>
                                    @foreach($departments as $department)
                                        <option value="{{$department->id}}" {{ old('department') ? 'selected' : '' }}>{{$department->naziv}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-field col m6 l6 xl4 offset-xl2">
                                ...
                                <textarea name="pozicija" id="pozicija" class="materialize-textarea" >{{Request::old('pozicija') ? : ''}}</textarea>
                            ...
                            <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <input type="number" name="satnica" id="satnica" value="{{Request::old('satnica') ? : ''}}" >
                            ...
                            <div class="input-field col s12 m6 l6 xl8 offset-xl2">
                                ...
                                <textarea name="status" id="status" class="materialize-textarea" >{{Request::old('status') ? : ''}}</textarea>
